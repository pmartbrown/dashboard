# Master To-Do / Follow-Up Tracker
...
| Item | Due | Context | Priority | Progress |
|------|-----|---------|----------|----------|
| Tauna Ellis → Marquee intro | ASAP | Returned the NDA. Follow up to remind her and schedule time on the calendar with her and Marquee to discuss funding and capital. | 🔴 High | — |
| Nancee Heckel — RV park training program call | ASAP | Still need to have the call. Re: training program for new RV park buyers. Learn more before judging. | 🟡 Medium | — |
...
| Item | Due | Context | Priority | Progress |
|------|-----|---------|----------|----------|
| Schedule appointment with Susan Byerly | 2026-04-10 | Blood tests and overall health check. Susan Byerly, FNP-C. Phone: (801) 224-3031. Email: myhealth@integrativehg.com. Address: 3315 W Mayflower Ave, STE 4, Lehi, UT. Website: integrativehg.com | 🔴 High | — |
| Seven Layers of Why — health session | 2026-04-04 | Saturday 9:00–11:40 AM (incl. 20 min travel). Recurring. Protect this time. | 🔴 High | — |

### Calendar — This Weekend
| Item | Due | Context | Priority | Progress |
|------|-----|---------|----------|----------|
| Seven Layers of Why | Sat 4/4 9:00 AM | 9:00–11:40 AM with travel | 🔴 High | — |
| Orem roof trip | Sat 4/4 1:00 PM | Drive to Orem, tour neighborhoods for roofs, drive back. Choose style/materials, order new roof. | 🔴 High | — |
| Owner's Club homework | Mon-Thu 7-8 PM | 4 weekly blocks, 1 hour each evening. | 🔴 High | — |

### Systems / AI
| Item | Due | Context | Priority | Progress |
|------|-----|---------|----------|----------|
| Set up property mortgage tracking | — | Track 4 properties, monthly payments, whether payments made, account balances. Heidi is property manager. Still needs to be built. | 🟡 Medium | — |
| Morning briefing improvement | — | Add deal funding signal detection. Blueprint at `brain/blueprints/morning-briefing-deal-funding-signals.md` | 🟡 Medium | — |
| Email management system — expand to additional inboxes | — | Working well on first email address. Expand one inbox at a time. | 🟡 Medium | — |
| Capital planning tool | — | Build a tool to plan and track deployment of capital across deals. | 🟡 Medium | — |
| EMD cancel/return alert tool | — | Monitor all active EMD deals and alert when an EMD needs to be canceled or returned. Pull signals from HubSpot deal stages + email + Slack. Track exactly where each deal stands relative to Go/No-Go. | 🔴 High | — |
| Social media engagement research — bi-weekly | Bi-weekly | Automated deep research: find most highly engaged posts on Facebook, Instagram, TikTok, LinkedIn, and YouTube. Deliver report with examples to mimic. Run every 2 weeks, ideally overnight. Leads to content creation that mirrors top-performing posts. | 🟡 Medium | — |
| Prediction markets / stock market quick-bet tool | — | Build a tool that can make quick bets in prediction markets or early-morning stock markets and track how they play out. | 🟡 Medium | — |
...
---
*Use any of these phrases: "follow-up", "to-do", "what's pending", "check my items", "open loops", "add a follow-up", "mark as done", etc.*
