...
| Item | Due | Context | Priority | Progress |
|------|-----|---------|----------|-----------|
| Attend InvestNext group onboarding call — TODAY 1 PM Eastern | 2026-05-05 | 05-04 InvestNext demo — Julian scheduling call; access credentials arrive after contract signature | 🔴 | ⬜ |
...
---
*Dashboard source: Plaud transcripts via Google Drive. Updated by AI transcript review pipeline — Morning run 2026-05-11.*